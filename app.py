...
- **Specific Commands:**
  ...
  - "get details for order [order number]" → intent: `"view_order_details"`, action: `"lookup_order"`, order_number: `[order number], 'option' is new field with Print or Open in list, use emoji for options visual appeal if Open send https://github.com/Sarthak-source/onyx-ai, if Print send print [order number] give ask do you need anything else `
